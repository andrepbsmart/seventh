...
namespace Prova.Application.Responses
{
    public static class Constants_Message
    {
        ...
        public const string STATUS_CODE_BADREQUEST = "Erro ao criar ou atualizar registro, verifique os dados informados";  //400 Bad Request - Essa resposta significa que o servidor não entendeu a requisição pois está com uma sintaxe inválida.
        ...
        public const string STATUS_CODE_NOTFOUND = "Registro solicitado não encotrado";                                     //404 Not Found - O servidor não pode encontrar o recurso solicitado. Este código de resposta talvez seja o mais famoso devido à frequência com que acontece na web.
        ...
        public const string STATUS_CODE_NOTIMPLEMENTED = "Não implementada";                                                //501 Not Implemented - O método da requisição não é suportado pelo servidor e não pode ser manipulado.O
    }
    public static class Constants_Code
    {
        #region status_de_respostas_HTTP
        ...
        //101 Switching Protocol - Esse código é enviado em resposta a um cabeçalho de solicitação Upgrade(en-US) pelo cliente, e indica o protocolo a que o servidor está alternando.
        ...
        //103 Early Hints -Este código tem principalmente o objetivo de ser utilizado com o cabeçalho Link, indicando que o agente deve iniciar a pré-carregar(en-US) recursos enquanto o servidor prepara uma resposta.
